package com.fluxbank.kyc.infrastructure.config;

import com.fluxbank.kyc.infrastructure.security.RequestHeaderAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                "/api/v1/kyc/api-docs/**",
                                "/api/v1/kyc/swagger-ui/**",
                                "/api/v1/kyc/swagger-ui.html"
                        ).permitAll()
