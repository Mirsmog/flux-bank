...
import com.fluxbank.payment.infrastructure.security.RequestHeaderAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                "/api/v1/payments/api-docs/**",
                                "/api/v1/payments/swagger-ui/**",
                                "/api/v1/payments/swagger-ui.html"
                        ).permitAll()
