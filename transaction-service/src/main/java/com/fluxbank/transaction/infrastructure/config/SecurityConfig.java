...
import com.fluxbank.transaction.infrastructure.security.RequestHeaderAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                "/api/v1/transactions/api-docs/**",
                                "/api/v1/transactions/swagger-ui/**",
                                "/api/v1/transactions/swagger-ui.html"
                        ).permitAll()
    ...
    /**
     * Prevents Spring Boot from registering RequestHeaderAuthFilter as a plain
     * servlet filter in addition to the Security filter chain, which would cause
